...
def _compute_interaction_cosine(head_position, gaze_direction, target, visual_cone=True):
    ...
    :param head_position: position of the head of person A, a list of two values [x_coord,y_coord]
    :param gaze_direction: gaze direction of the head of person A [x_component, y_component], better if normalized
